...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(1092)
)
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/SUS-RunIISpring15FSPremix-00218-fragment.py nevts:1092'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:T2bW_500_LSP0-run41718_decayed_1000024_250__1000022_1_step1.root'),
