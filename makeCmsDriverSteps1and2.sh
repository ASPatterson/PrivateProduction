...
--datamix PreMix \
--python_filename T2bW_500_LSP0-run41718_decayed_1000024_250__1000022_1_1_cfg.py \
--no_exec -n 1092 || exit $? ; 
...
--conditions MCRUN2_74_V9 \
--step PAT \
--python_filename T2bW_500_LSP0-run41718_decayed_1000024_250__1000022_1_2_cfg.py \
--no_exec -n 1092 || exit $? ;
