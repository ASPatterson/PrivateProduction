...
# with command line options: Configuration/GenProduction/python/SUS-RunIISpring15FSPremix-00218-fragment.py --filein file:/afs/cern.ch/work/a/apatters/private/decayedLHE/T2bW_500_LSP0-run41718_decayed_1000024_250__1000022_1.lhe --fileout file:T2bW_500_LSP0-run41718_decayed_1000024_250__1000022_1_step1.root --mc --eventcontent RAWSIM --fast --customise SLHCUpgradeSimulations/Configuration/postLS1CustomsPreMixing.customisePostLS1,Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --conditions MCRUN2_74_V9 --beamspot NominalCollision2015 --step GEN,SIM --magField 38T_PostLS1 --python_filename submitStep0_untemplated_cfg.py --no_exec -n -1
...
myOutputCommands = process.RAWSIMEventContent.outputCommands
myOutputCommands.extend(['keep *_famosSimHits_*_*', ##includes TrackerHits via *_famosSimHits_TrackerHits_*
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:T2bW_<mSTOP>_seed<seed>_decayed_1000024_<mNLSP>__1000022_<mLSP>_step0.root'),
