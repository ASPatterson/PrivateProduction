...
# with command line options: step1 --mc --eventcontent MINIAODSIM --runUnscheduled --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1 --datatier MINIAODSIM --conditions 74X_mcRun2_asymptotic_v2 --step PAT --filein file:AOD.root --fileout file:miniaodv2.root -n -1 --python_filename submitStep3_untemplated_cfg.py --no_exec
