...
# with command line options: step2 --mc --eventcontent AODSIM --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1 --datatier AODSIM --conditions MCRUN2_74_V9 --step RAW2DIGI,L1Reco,RECO --magField 38T_PostLS1 --filein file:DIGI.root --fileout file:AOD.root -n -1 --python_filename submitStep2_untemplated_cfg.py --no_exec
